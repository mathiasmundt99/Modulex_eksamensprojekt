...
async function loadUserData(userId) {
  ...
  const latestActivity = userCourses.reduce((latest, c) => {
  ...
  activityLog.value = activityResponse.data?.data || activityResponse.data || [];
  enrolledCourses.value = mapCourses(userCourses);
}
